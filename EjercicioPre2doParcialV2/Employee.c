...
int em_calcularSueldo(void* p)
{
    int returnAux=-1;
    int horasTrab;
    employee_getHorasTrabajadas((Employee*)p,&horasTrab);
    if (horasTrab<=120)
    {
        employee_setSueldo((Employee*)p,horasTrab*180);
        returnAux=0;
    }
    else if (horasTrab<=160)
    {
        horasTrab=((horasTrab-120)*240)+(120*180);
        employee_setSueldo((Employee*)p,horasTrab);
        returnAux=0;
    }
    else
    {
        horasTrab=((horasTrab-160)*350)+(40*240)+(120*180);
        employee_setSueldo((Employee*)p,horasTrab);
        returnAux=0;
    }
    return returnAux;
...
int em_filtraPorsueldo(void* p)
{
    int returnAux=0;
    if ((((Employee*)p)->id)>150)
    {
        returnAux= 1;
    }
    return returnAux;
